...
<body class="navbar-top">
	...
	<div class="page-content">
		...
		<?php include('main_entreprise.php'); ?>
			...
			<!-- Afficher l'état de progression du questionnaire -->
			            <div class="card card-body border-top-1 border-top-primary">
							<div class="text-center">
								...
								<p class="mb-3 text-muted">Exécutez des actions pour débloquer de nouvelles fonctionnalités. En moyenne, les pages terminées obtiennent 30 % de trafic supplémentaire. <a href="">En savoir plus</a> </p> 
							</div>
...
<!-- Mirrored from demo.interface.club/limitless/demo/bs4/Template/layout_1/LTR/material/full/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 May 2019 13:38:49 GMT -->
</html>
